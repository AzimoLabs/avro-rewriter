...
public class ReadAvroFilesAsSpecificRecordsTr extends PTransform<PBegin, PCollection<AvroRecord>> {
    public static final String AVRO_FILES_SUFFIX = Constants.AVRO_FILE_NAME_PREFIX + "-*.avro";

    private List<String> paths;

    public ReadAvroFilesAsSpecificRecordsTr(List<String> paths) {
        this.paths = paths;
    }
